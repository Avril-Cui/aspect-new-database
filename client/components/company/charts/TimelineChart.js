...
const DayDimension = (props) => {
    ...
    series: [
      {
        ...
        markPoint: {
          data: [
            {
              name: "Happened Events",
              coord: ["07/20/2071 ", 3500],
              labelLine: {
                length: 100,
              },
              label: {
                formatter: "{b|Musk's bet on \n Bitcoin fails}",
                backgroundColor: "#72B176",
                borderRadius: 4,
                rich: {
                  b: {
                    color: "#ffffff",
            ...
            {
              name: "Happened Events",
              coord: ["08/20/2071 ", 2500],
              labelLine: {
                length: 100,
              },
              label: {
                formatter: "{b|Tesla stock \n by 10% today.}",
                backgroundColor: "#72B176",
                borderRadius: 4,
                rich: {
                  b: {
            ...
            {
              name: "Happened Events",
              coord: ["07/04/2071 ", 3550],
              labelLine: {
                length: 100,
              },
              label: {
                formatter: "{b|Chip supply \nchain announce.}",
                backgroundColor: "#72B176",
                borderRadius: 4,
                rich: {
                  b: {
            ...
            {
              name: "Happened Events",
              coord: ["09/04/2071 ", 2500],
              labelLine: {
                length: 100,
              },
              label: {
                formatter: "{b|Yearly financials \n released today.}",
                backgroundColor: "#72B176",
                borderRadius: 4,
                rich: {
                  b: {
            ...
            {
              name: "Happened Events",
              coord: ["07/30/2071 ", 2000],
              labelLine: {
                length: 100,
              },
              label: {
                formatter: "{b|Musk announced\n Twitter M&A.}",
                backgroundColor: "#72B176",
                borderRadius: 4,
                rich: {
                  b: {
  ...
  return <ReactEcharts style={{ height: 450 }} option={option} />;
};
