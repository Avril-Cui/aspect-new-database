            ...
            <div className={styles.pop_up_container}>
              <div className={styles.box}>
                <div className={styles.inline}>
                  ...
                  <button className={styles.close_candlestick} onClick={togglePopclose}>X</button>
                </div>
                <p
          ...
          <div className={styles.inline}>
            <p className={styles.comp_type_price}>
              {props.price_data[comp_name] != undefined
                ? formatter.format(props.price_data[comp_name]["end_price"])
                : "N/A"}{" "}
              <span>ASD</span>
            </p>
            <p
            ...
            >
              {price_data[comp_name] != undefined
                ? formatter.format(price_data[comp_name]["pct_change"] * 100)
                : "N/A"}
              %
            </p>
          </div>
