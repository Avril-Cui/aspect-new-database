...
start_date_comp = "2012/5/11"
end_date_comp = "2014/1/1"
symbol_comp = ["META"]
...
simulated_price_comp, tick_based_price_list_comp, day_based_price_list_comp, second_based_price_list_comp = generate_stock_parameter(stock_price_list, stock_price_comp, index_price, target_adjustment, comp_weight, index_weight)
