...
def generate_stock_parameter(original_price, original_index_price, target_adjustment, comp_weight, index_weight):
    ...
    for index in range(len(sampling_price_list)):
        ...
        simulated_price.append(simulated_price[-1]+(mean_company)* simulated_price[-1] + sigm * dWt)
...
tick_based_price_list_comp, day_based_price_list_comp, second_based_price_list_comp = generate_stock_parameter(stock_price_comp, index_price, target_adjustment, comp_weight, index_weight)
