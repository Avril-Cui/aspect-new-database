...
def generate_stock_parameter(original_price_list, original_index_price, target_adjustment, comp_weight, index_weight):
    ...
    original_price = pd.DataFrame(original_price_list, columns=["META"])


    sigma = []
    convolution_df = index_price_df.rolling(window=10).mean()
...
simulated_price, tick_based_price_list, day_based_price_list, second_based_price_list = generate_stock_parameter(stock_price_list, index_price, target_adjustment, comp_weight, index_weight)
