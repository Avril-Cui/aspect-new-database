...
mu_df_comp = convolution_df_comp.pct_change()[10:]
mu_comp = mu_df_comp["META"].to_list()
...
start_date_comp_1 = "2016/3/1"
end_date_comp_1 = "2017/4/1"
symbol_comp_1 = ['NTDOY']
...
convolution_df_comp_1 = stock_price_comp_1.rolling(window=10).mean()
mu_df_comp_1 = convolution_df_comp_1.pct_change()[10:]
mu_comp_1 = mu_df_comp_1["NTDOY"].to_list()
target_adjustment_1 = second_based_price_list_comp[-1]
comp_weight_1 = 0.8
index_weight_1 = 0.2
tick_based_price_list_comp_1, day_based_price_list_comp_1, second_based_price_list_comp_1 = generate_stock_parameter(mu_comp_1, stock_price_list_1, index_price, target_adjustment_1, comp_weight_1, index_weight_1)
