...
def generate_stock_parameter(stock_list, original_index_price, target_adjustment):
    ...
    for index in range(len(sampling_price_list)):
        ...
        simulated_price.append(simulated_price[-1]+theta_tmp * (mu_tmp-simulated_price[-1]) +sigm * dWt)
...
tick_based_price_list_comp, day_based_price_list_comp, second_based_price_list_comp = generate_stock_parameter(stock_price_list, index_price, target_adjustment)
...
aspect_simulator_wrkn_tick.to_csv('/Users/xiaokeai/Desktop/price_data/wrkn_tick_price.csv')
aspect_simulator_wrkn_day.to_csv('/Users/xiaokeai/Desktop/price_data/wrkn_day_price.csv')
aspect_simulator_wrkn_second.to_csv('/Users/xiaokeai/Desktop/price_data/wrkn_second_price.csv')
