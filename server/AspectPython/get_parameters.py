...
def get_index_parameters_1929_roaring_twenties():
	...
	index_price_df = pd.read_csv("/Users/xiaokeai/Desktop/aspect-dashboard/server/AspectPython/historical_price/index_data/1929_roaring_twenties.csv")
...
def wrkn_2012_IPO_macro():
	...
	"""
	comp_price_df = pd.read_csv("/Users/xiaokeai/Desktop/aspect-dashboard/server/AspectPython/historical_price/WRKN/WRKN_IPO.csv")
