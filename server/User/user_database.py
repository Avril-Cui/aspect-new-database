...
class UserDatabaseCommands:
    ...
    def get_portfolio_info(user_uid):
        cur.execute(f"""
            SELECT users.cashvalue, portfolio.company_id, portfolio.shares_holding
...
# UserDatabaseCommands.trade_stock('Avril', 10, 50, 50, "sgo")



# time.sleep(1)
# UserDatabaseCommands.trade_stock('Avril', 5, 50, 50, "wrkn")
# UserDatabaseCommands.intialize_user('Friday', 'friday')
# UserDatabaseCommands.get_portfolio_info('Avril')
# UserDatabaseCommands.get_total_rank()
