class UserPortfolio:
    ...
    def initialize_portfolio(self):
        ...
        user_portfolio = {
            "portfolio_value": {
                ...
                "holdingValue": self.holding_value,
            }
        }
    ...
    def update_value(
        ...
        for key in name_price_dict:
            ...
            self.portfolio["portfolio_value"]["holdingValue"] = round(self.default_initial_value + (name_price_dict[key] * self.portfolio[key]["shares"]- self.portfolio[key]["total_holdings"]),2)
            self.portfolio[key]["total_worth"] = round(name_price_dict[key] * self.portfolio[key]["shares"],2)
        return (self.portfolio)
