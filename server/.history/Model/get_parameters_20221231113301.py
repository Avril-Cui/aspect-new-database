...
def micro(
	...
	return parameter_dict
#Index
file_names = ['normal1', 'mete1_1', 'mete1_2', 'mete2', 'mete3', 'mete4', 'mete5']
length = [50, 50, 30, 50, 50, 60, 60]
length1 = np.add(length, 10)
fund_weights = [0.5, 0.6, 0.85, 0.85, 0.7, 0.65, 0.7, 0.85]
index_params = {}
for index in range(len(file_names)):
	...
	index_params[name] = {
		...
		"scale_lamb": 120,
		"scale_mu": 130,
		"fund_weight": fund_weights[index]
	}