...
index1 = pd.read_csv("Model/historical_price/index_data/mete1_1.csv")["Adj Close"]
index_price1 = index1.to_list()
index_price1 = np.divide(index_price1, index_price1[0])
index_price.extend(index_price1)

index2 = pd.read_csv("Model/historical_price/index_data/mete1_2.csv")["Adj Close"]
index_price2 = index2.to_list()
index_price2 = np.divide(index_price2, index_price2[0])
index_price.extend(index_price2)

index3 = pd.read_csv("Model/historical_price/index_data/mete2.csv")["Adj Close"]
index_price3 = index3.to_list()
index_price3 = np.divide(index_price3, index_price3[0])
index_price.extend(index_price3)

index4 = pd.read_csv("Model/historical_price/index_data/mete3.csv")["Adj Close"]
index_price4 = index4.to_list()
index_price4 = np.divide(index_price4, index_price4[0])
index_price.extend(index_price4)

index5 = pd.read_csv("Model/historical_price/index_data/mete4.csv")["Adj Close"]
index_price5 = index5.to_list()
index_price5 = np.divide(index_price5, index_price5[0])
index_price.extend(index_price5)

index6 = pd.read_csv("Model/historical_price/index_data/mete5.csv")["Adj Close"]
index_price6 = index6.to_list()
index_price6 = np.divide(index_price6, index_price6[0])
index_price.extend(index_price6)
