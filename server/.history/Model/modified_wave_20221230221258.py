...
class WaveModifier:
    ...
    def price_wave_addition(self, transformation, intensity, length, *argv):
        ...
        for wave_info in argv:
            ...
            print(start_point, end_point, wave_info['duration'])
            print(len(price_list), len(wave_info['price_list'][start_point:end_point]))
            ...
            print(len(price_list), len(weighted_wave))
