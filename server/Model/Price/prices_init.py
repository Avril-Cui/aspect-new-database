import param_init
from alg_price import MidPriceGenerator, DayPriceGenerator, WaveModifier, StockSimulator
import numpy as np
...
index_price = get_stock_price(param_init.file_names_index, param_init.index_params_index, intensity, param_init.length_index,
param_init.fund_weights_index, mid_prices_index, mid_start, [900, 900, 1100, 900, 600, 700, 220], 1200, sigma)
...
mid_start = [0, 0, 0, 0, 0]
sigma = [2,2,4.5,3,3]
ast_price = get_stock_price(param_init.file_names_ast, param_init.params_ast, intensity, param_init.length_ast,
param_init.fund_weights_ast, mid_prices_index, mid_start, [140, 300, 100, 250, 150], 50, sigma)
...
dsc_price = get_stock_price(param_init.file_names_dsc, param_init.params_dsc, intensity, param_init.length_dsc,
param_init.fund_weights_dsc, mid_prices_index, mid_start, [40, 135, 200, 120], 39.78, sigma)

mid_price_index1 = MidPriceGenerator.generate_mid_price("2019-12-15", "2021-8-1", ["^GSPC"], 15)
mid_prices_index = [mid_price_index1, mid_price_index1, mid_price_index1, mid_price_index1]
mid_start = [0, 150, 190, 270, 300]
sigma = [0.5, 0.2, 0.85, 0.5]
fsin_price = get_stock_price(param_init.file_names_fsin, param_init.params_fsin, intensity, param_init.length_fsin,
param_init.fund_weights_fsin, mid_prices_index, mid_start, [30, 100, 62, 40], 60, sigma)
...
hhw_price = get_stock_price(param_init.file_names_hhw, param_init.params_hhw, intensity, param_init.length_hhw,
param_init.fund_weights_hhw, mid_prices_index, mid_start, [70, 170, 150, 40], 70, sigma)

mid_price_index1 = MidPriceGenerator.generate_mid_price("2021-8-15", "2022-12-1", ["^GSPC"], 15)
mid_prices_index = [mid_price_index1, mid_price_index1, mid_price_index1, mid_price_index1]
mid_start = [0, 20, 110, 190]
sigma = [0.55, 0.55, 0.6, 0.5]
jky_price = get_stock_price(param_init.file_names_jky, param_init.params_jky, intensity, param_init.length_jky,
param_init.fund_weights_jky, mid_prices_index, mid_start, [45, 50, 50, 80], 60, sigma)
...
sgo_price = get_stock_price(param_init.file_names_sgo, param_init.params_sgo, intensity, param_init.length_sgo,
param_init.fund_weights_sgo, mid_prices_index, mid_start, [100, 280, 2000, 80, 110], 80, sigma)

mid_price_index1 = MidPriceGenerator.generate_mid_price("2021-8-15", "2022-12-1", ["^GSPC"], 15)
mid_prices_index = [mid_price_index1, mid_price_index1, mid_price_index1]
mid_start = [0, 200, 230]
sigma = [0.4, 0.35, 0.5]
wrkn_price = get_stock_price(param_init.file_names_wrkn, param_init.params_wrkn, intensity, param_init.length_wrkn,
param_init.fund_weights_wrkn, mid_prices_index, mid_start, [70, 70, 50], 70, sigma)
